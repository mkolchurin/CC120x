...
#define SYNC_CFG0 0x0009 //Sync Word Detection Configuration Reg. 0
...
#define IQIC 0x000F //Digital Image Channel Compensation Configuration
#define CHAN_BW 0x0010 //Channel Filter Configuration
#define MDMCFG1 0x0011 //General Modem Parameter Configuration Reg. 1
#define MDMCFG0 0x0012 //General Modem Parameter Configuration Reg. 0
#define SYMBOL_RATE2 0x0013 //Symbol Rate Configuration Exponent and Mantissa [1..
#define SYMBOL_RATE1 0x0014 //Symbol Rate Configuration Mantissa [15:8]
#define SYMBOL_RATE0 0x0015 //Symbol Rate Configuration Mantissa [7:0]
#define AGC_REF 0x0016 //AGC Reference Level Configuration
#define AGC_CS_THR 0x0017 //Carrier Sense Threshold Configuration
#define AGC_GAIN_ADJUST 0x0018 //RSSI Offset Configuration
#define AGC_CFG3 0x0019 //Automatic Gain Control Configuration Reg. 3
#define AGC_CFG2 0x001A //Automatic Gain Control Configuration Reg. 2
#define AGC_CFG1 0x001B //Automatic Gain Control Configuration Reg. 1
#define AGC_CFG0 0x001C //Automatic Gain Control Configuration Reg. 0
#define FIFO_CFG 0x001D //FIFO Configuration
#define DEV_ADDR 0x001E //Device Address Configuration
#define SETTLING_CFG 0x001F //Frequency Synthesizer Calibration and Settling Con..
#define FS_CFG 0x0020 //Frequency Synthesizer Configuration
#define WOR_CFG1 0x0021 //eWOR Configuration Reg. 1
#define WOR_CFG0 0x0022 //eWOR Configuration Reg. 0
#define WOR_EVENT0_MSB 0x0023 //Event 0 Configuration MSB
#define WOR_EVENT0_LSB 0x0024 //Event 0 Configuration LSB
#define RXDCM_TIME 0x0025 //RX Duty Cycle Mode Configuration
...
#define PA_CFG1 0x002B //Power Amplifier Configuration Reg. 1
#define PA_CFG0 0x002C //Power Amplifier Configuration Reg. 0
#define ASK_CFG 0x002D //ASK Configuration
...
#define MDMCFG2 0x2F05 //General Modem Parameter Configuration Reg. 2
...
#define CHFILT_I2 0x2F86 //Channel Filter Data Real Part [16]
#define CHFILT_I1 0x2F87 //Channel Filter Data Real Part [15:8]
#define CHFILT_I0 0x2F88 //Channel Filter Data Real Part [7:0]
#define CHFILT_Q2 0x2F89 //Channel Filter Data Imaginary Part [16]
...
#define AES 0x2FA1 //AES
#define MDM_TEST 0x2FA2 //MODEM Test
...
#define RXFIFO_PRE_BUF 0x2FDA //RX FIFO Status
#define AES_KEY15 0x2FE0 //Advanced Encryption Standard Key [127:120]
#define AES_KEY14 0x2FE1 //Advanced Encryption Standard Key [119:112]
#define AES_KEY13 0x2FE2 //Advanced Encryption Standard Key [111:104]
#define AES_KEY12 0x2FE3 //Advanced Encryption Standard Key [103:96]
#define AES_KEY11 0x2FE4 //Advanced Encryption Standard Key [95:88]
#define AES_KEY10 0x2FE5 //Advanced Encryption Standard Key [87:80]
#define AES_KEY9 0x2FE6 //Advanced Encryption Standard Key [79:72]
#define AES_KEY8 0x2FE7 //Advanced Encryption Standard Key [71:64]
#define AES_KEY7 0x2FE8 //Advanced Encryption Standard Key [63:56]
#define AES_KEY6 0x2FE9 //Advanced Encryption Standard Key [55:48]
#define AES_KEY5 0x2FEA //Advanced Encryption Standard Key [47:40]
#define AES_KEY4 0x2FEB //Advanced Encryption Standard Key [39:32]
#define AES_KEY3 0x2FEC //Advanced Encryption Standard Key [31:24]
#define AES_KEY2 0x2FED //Advanced Encryption Standard Key [23:16]
#define AES_KEY1 0x2FEE //Advanced Encryption Standard Key [15:8]
#define AES_KEY0 0x2FEF //Advanced Encryption Standard Key [7:0]
#define AES_BUFFER15 0x2FF0 //Advanced Encryption Standard Buffer [127:120]
#define AES_BUFFER14 0x2FF1 //Advanced Encryption Standard Buffer [119:112]
#define AES_BUFFER13 0x2FF2 //Advanced Encryption Standard Buffer [111:104]
#define AES_BUFFER12 0x2FF3 //Advanced Encryption Standard Buffer [103:93]
#define AES_BUFFER11 0x2FF4 //Advanced Encryption Standard Buffer [95:88]
#define AES_BUFFER10 0x2FF5 //Advanced Encryption Standard Buffer [87:80]
#define AES_BUFFER9 0x2FF6 //Advanced Encryption Standard Buffer [79:72]
#define AES_BUFFER8 0x2FF7 //Advanced Encryption Standard Buffer [71:64]
#define AES_BUFFER7 0x2FF8 //Advanced Encryption Standard Buffer [63:56]
#define AES_BUFFER6 0x2FF9 //Advanced Encryption Standard Buffer [55:48]
#define AES_BUFFER5 0x2FFA //Advanced Encryption Standard Buffer [47:40]
#define AES_BUFFER4 0x2FFB //Advanced Encryption Standard Buffer [39:32]
#define AES_BUFFER3 0x2FFC //Advanced Encryption Standard Buffer [31:24]
#define AES_BUFFER2 0x2FFD //Advanced Encryption Standard Buffer [23:16]
...
#define settingsSize() (sizeof(preferredSettings)/sizeof((preferredSettings)[0]))
//0x9 serial rx; 0x8 serial clock
